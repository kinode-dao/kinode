...
const MessagePopup: React.FC<MessagePopupProps> = ({ type, content, onClose, autoCloseDelay = 5000 }) => {
    ...
    return (
        <div className={`fixed bottom-4 right-4 p-4 rounded-lg shadow-lg flex items-center gap-4 max-w-md ${type === 'success' ? 'bg-green-600' : type === 'error' ? 'bg-red-600' : 'bg-blue-600'}`}>
